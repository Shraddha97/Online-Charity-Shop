...
<html>
    <head>
        ...
        if (isset($_SESSION['buyer_session'])) {
            ...
            if($buyer_id !== $b_id){
                header("location:product_details.php?b_id=$buyer_id");
            }
        } else {
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        <div class="col-lg-6 product-details">
                            ...
                            <form action="add_to_cart.php" method="post">
                                <input type="hidden" value="<?php echo $b_id ?>" name="b_id" required/>
                                <input type="hidden" value="<?php echo $p_id ?>" name="p_id" required/>
                                <input type="hidden" value="<?php echo $row['p_name'] ?>" name="p_name" required/>
                                <input type="hidden" value="<?php echo $thumb_img ?>" name="p_img" required/>
                                ...
                                <div class="fw-size-choose">
                                    ...
                                    ?>
                                    <div class="sc-item <?php if (in_array("XS", $size_list)) {
                                    
                                } else {
                                        ?>disable<?php } ?>">
                                        <input type="radio" <?php if (in_array("XS", $size_list)) {
                                     
                                 } else {
                                     ?>disabled="disabled"<?php } ?> value="XS" name="sc" id="x-small">
                                        <label for="x-small">XS</label>
                                    </div>
                                    <div class="sc-item <?php if (in_array("S", $size_list)) {
                                     
                                 } else {
                                        ?>disable<?php } ?>">
                                        <input type="radio" <?php if (in_array("S", $size_list)) {
                                               
                                           } else {
                                               ?>disabled="disabled"<?php } ?> value="S" name="sc" id="small">
                                        <label for="small">S</label>
                                    </div>
                                    <div class="sc-item <?php if (in_array("M", $size_list)) {
                                    
                                } else {
                                    ?>disable<?php } ?>">
                                        <input type="radio" <?php if (in_array("M", $size_list)) {
                                    
                                } else {
                                        ?>disabled="disabled"<?php } ?> value="M" name="sc" id="medium">
                                        <label for="medium">M</label>
                                    </div>
                                    <div class="sc-item <?php if (in_array("L", $size_list)) {
                                     
                                 } else {
                                     ?>disable<?php } ?>">
                                        <input type="radio" <?php if (in_array("L", $size_list)) {
                                    
                                } else {
                                        ?>disabled="disabled"<?php } ?> value="L" name="sc" id="large">
                                        <label for="large">L</label>
                                    </div>
                                    <div class="sc-item <?php if (in_array("XL", $size_list)) {
                                               
                                           } else {
                                        ?>disable<?php } ?>">
                                        <input type="radio" <?php if (in_array("XL", $size_list)) {
                                     
                                 } else {
                                     ?>disabled="disabled"<?php } ?> value="XL" name="sc" id="x-large">
                                        <label for="x-large">XL</label>
                                    </div>
                                    <div class="sc-item <?php if (in_array("XXL", $size_list)) {
                                     
                                 } else {
                                     ?>disable<?php } ?>">
                                        <input type="radio" <?php if (in_array("XXL", $size_list)) {
    ...
    <!--                                <div class="pro-qty"><input type="text" value="1"></div>-->.
                                    <select class="form-control itemQty" name="p_qty" style="width: 60px" required>
                                ...
                                <button class="site-btn" name="submit">SHOP NOW</button>
                            </form>
