                            ...
                            <div class="product-item">
                                <div class="pi-pic">
                                    ...
                                    while ($row_thumb_img = mysqli_fetch_array($result_thumb_img)) {
                                        ...
                                        ?>
                                        <a href="product_details?p_id=<?php echo $p_id ?>&category=<?php echo $row['sub_category'] ?>"><img src="<?php echo $row_thumb_img['thumbnail']; ?>" alt=""></a>
                                        <?php
                                    }
                                    ?>
                                    <div class="pi-links">
                                ...
                                <div class="pi-text">
                                    ...
                                    <a href="product_details?p_id=<?php echo $p_id ?>&category=<?php echo $row['sub_category'] ?>"><p><?php echo $row['p_name'] ?></p></a>
                                </div>
                            </div>
                        </div>
                        <?php
